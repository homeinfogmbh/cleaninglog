...
_GenerationUID = pyxb.utils.utility.UniqueIdentifier(
    "urn:uuid:94f86e7e-569a-11ed-b52d-7427eaa9df7d"
)
...
Namespace = pyxb.namespace.NamespaceForURI(
    "http://xml.homeinfo.de/schema/cleaning", create_if_missing=True
)
...
class Cleanings(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 22, 4
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __cleaning = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, "cleaning"),
        "cleaning",
        "__httpxml_homeinfo_deschemacleaning_Cleanings_cleaning",
        True,
        pyxb.utils.utility.Location(
            "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 29, 12
        ),
    )
    ...
    _ElementMap.update({__cleaning.name(): __cleaning})
...
class Cleaning(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 40, 4
    )
    _ElementMap = {}
    _AttributeMap = {}
    # Base type is pyxb.binding.datatypes.anyType
    ...
    __timestamp = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, "timestamp"),
        "timestamp",
        "__httpxml_homeinfo_deschemacleaning_Cleaning_timestamp",
        False,
        pyxb.utils.utility.Location(
            "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 47, 12
        ),
    )
    ...
    __user = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, "user"),
        "user",
        "__httpxml_homeinfo_deschemacleaning_Cleaning_user",
        False,
        pyxb.utils.utility.Location(
            "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 54, 12
        ),
    )
    ...
    __annotation = pyxb.binding.content.ElementDeclaration(
        pyxb.namespace.ExpandedName(None, "annotation"),
        "annotation",
        "__httpxml_homeinfo_deschemacleaning_Cleaning_annotation",
        True,
        pyxb.utils.utility.Location(
            "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 61, 12
        ),
    )
...
class User(pyxb.binding.basis.complexTypeDefinition):
    ...
    _XSDLocation = pyxb.utils.utility.Location(
        "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 72, 4
    )
    _ElementMap = {}
    _AttributeMap = {}
    ...
    __type = pyxb.binding.content.AttributeUse(
        ...
        "type",
        "__httpxml_homeinfo_deschemacleaning_User_type",
        pyxb.binding.datatypes.string,
    )
    __type._DeclarationLocation = pyxb.utils.utility.Location(
        "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 80, 16
    )
...
cleanings = pyxb.binding.basis.element(
    pyxb.namespace.ExpandedName(Namespace, "cleanings"),
    Cleanings,
    documentation="\n                Wurzelelement.\n            ",
    location=pyxb.utils.utility.Location(
        "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 13, 4
    ),
)
Namespace.addCategoryObject("elementBinding", cleanings.name().localName(), cleanings)


Cleanings._AddElement(
...
def _BuildAutomaton():
    ...
    symbol = pyxb.binding.content.ElementUse(
        Cleanings._UseForTag(pyxb.namespace.ExpandedName(None, "cleaning")),
        pyxb.utils.utility.Location(
            "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 29, 12
        ),
    )
...
def _BuildAutomaton_():
    ...
    final_update = None
    symbol = pyxb.binding.content.ElementUse(
        Cleaning._UseForTag(pyxb.namespace.ExpandedName(None, "timestamp")),
        pyxb.utils.utility.Location(
            "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 47, 12
        ),
    )
    ...
    final_update = set()
    symbol = pyxb.binding.content.ElementUse(
        Cleaning._UseForTag(pyxb.namespace.ExpandedName(None, "user")),
        pyxb.utils.utility.Location(
            "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 54, 12
        ),
    )
    ...
    final_update.add(fac.UpdateInstruction(cc_0, False))
    symbol = pyxb.binding.content.ElementUse(
        Cleaning._UseForTag(pyxb.namespace.ExpandedName(None, "annotation")),
        pyxb.utils.utility.Location(
            "/home/neumann/Projekte/cleaninglog/cleaning.xsd", 61, 12
        ),
    )
